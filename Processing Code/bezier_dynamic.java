...
void draw() {
  ...
  myBazier.addPoint(new PVector(400 + (60*sin(period)), 300 + (25*cos(period)), 0));
  myBazier.addPoint(new PVector(500 + (85*sin(period)), 200 + (35*sin(period)), 0));
  myBazier.addPoint(new PVector(600 + (100*cos(period)), 300 + (85*sin(period)), 0));
  myBazier.addPoint(new PVector(700 + (25*cos(period)), 200 + (35*sin(period)), 0));
